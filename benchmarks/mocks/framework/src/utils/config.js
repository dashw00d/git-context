...
exports.getProjectId = exports.getGitRoot = exports.getWorkspaceRoot = exports.isCstOnlyLanguage = exports.getAugmentableLanguages = exports.getJSLanguages = exports.isPHPLanguage = exports.isJSLanguage = exports.LANGUAGES = exports.detectLanguage = exports.getTestFilePattern = exports.getSupportedLanguages = exports.getSupportedExtensions = exports.getExtensionConfig = exports.getPackageJsonDefault = void 0;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const crypto = __importStar(require("crypto"));
const supportedLanguages_1 = require("./supportedLanguages");
Object.defineProperty(exports, "getSupportedExtensions", { enumerable: true, get: function () { return supportedLanguages_1.getSupportedExtensions; } });
Object.defineProperty(exports, "getSupportedLanguages", { enumerable: true, get: function () { return supportedLanguages_1.getSupportedLanguages; } });
Object.defineProperty(exports, "getTestFilePattern", { enumerable: true, get: function () { return supportedLanguages_1.getTestFilePattern; } });
Object.defineProperty(exports, "detectLanguage", { enumerable: true, get: function () { return supportedLanguages_1.detectLanguage; } });
Object.defineProperty(exports, "LANGUAGES", { enumerable: true, get: function () { return supportedLanguages_1.LANGUAGES; } });
Object.defineProperty(exports, "isJSLanguage", { enumerable: true, get: function () { return supportedLanguages_1.isJSLanguage; } });
Object.defineProperty(exports, "isPHPLanguage", { enumerable: true, get: function () { return supportedLanguages_1.isPHPLanguage; } });
Object.defineProperty(exports, "getJSLanguages", { enumerable: true, get: function () { return supportedLanguages_1.getJSLanguages; } });
Object.defineProperty(exports, "getAugmentableLanguages", { enumerable: true, get: function () { return supportedLanguages_1.getAugmentableLanguages; } });
Object.defineProperty(exports, "isCstOnlyLanguage", { enumerable: true, get: function () { return supportedLanguages_1.isCstOnlyLanguage; } });
let vscode;
try {
 ...
 */
function getPackageJsonDefault(key) {
    const packageJson = getPackageJson();
    const props = packageJson?.contributes?.configuration?.properties || {};
    const fullKey = `git-context.${key}`;
    return props[fullKey]?.default;
}
exports.getPackageJsonDefault = getPackageJsonDefault;
/**
 * Load configuration from file if it exists
 */
let cachedFileConfig = undefined;
...
if (vscode) {
    vscode.workspace.onDidChangeConfiguration((e) => {
        if (e.affectsConfiguration('git-context.allowedExtensions') ||
            ...
            (0, supportedLanguages_1.invalidateCache)();
            // Check if WASM files are missing for new extensions (async check)
            (async () => {
                try {
                    const { getSupportedExtensions, getRequiredLanguagesForExtensions } = await Promise.resolve().then(() => __importStar(require('./supportedLanguages')));
                    const fs = require('fs');
                    ...
                    if (missingLangs.length > 0) {
                        const action = await vscode.window.showInformationMessage(`Missing WASM files for languages: ${missingLangs.join(', ')}. Would you like to download them?`, 'Download', 'Later');
                        if (action === 'Download') {
...
function findGitRootForPath(startPath) {
