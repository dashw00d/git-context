...
exports.analyzeConventionDrift = exports.suggestConventionName = exports.detectNamingConvention = void 0;
/**
...
exports.detectNamingConvention = detectNamingConvention;
/**
 * Suggest a name following a target convention
 */
function suggestConventionName(name, targetConvention) {
...
exports.suggestConventionName = suggestConventionName;
/**
 * Analyze convention drift across a set of symbols
 */
function analyzeConventionDrift(symbols) {
    const counts = {
        'camelCase': 0,
        'PascalCase': 0,
        'snake_case': 0,
    ...
    const conventionEntries = Object.entries(counts)
        .filter(([k]) => k !== 'unknown')
        .sort(([, a], [, b]) => b - a);
    const dominant = conventionEntries[0]?.[0] || 'unknown';
...
exports.analyzeConventionDrift = analyzeConventionDrift;
