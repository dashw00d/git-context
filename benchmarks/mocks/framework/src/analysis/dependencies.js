...
const edgeThresholds_1 = require("../utils/edgeThresholds");
class DependencyExtractor {
    ...
    extractImports(content, filePath, language, knownSymbols) {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            if ((0, config_1.isPHPLanguage)(language)) {
            ...
            if ((0, config_1.isJSLanguage)(language)) {
                // JS/TS imports
     ...
     */
    async extractWorkingTreeEdges(files, symbols, git) {
        const currentEdges = [];
    ...
    isEdgeResolved(edge) {
        ...
        return (edge.confidence ?? 0) > (0, edgeThresholds_1.getDefaultThreshold)();
    }
    /**
