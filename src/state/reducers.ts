...
export function cockpitReducer(state: CockpitState = initialState, action: Action): CockpitState {
    switch (action.type) {
        ...
        case 'ANALYSIS_STEP_UPDATED':
            return { ...state, analysisStep: action.payload.step, analysisProgress: action.payload.progress };
        ...
        case 'SELECTION_CLEARED':
            return { ...state, selectedCommitShas: [], selectedStagedPaths: [], selectedUnstagedPaths: [] };
        case 'SELECTION_SET':
        ...
        case 'WORKSPACE_FILES_UPDATED':
            return { ...state, stagedFiles: action.payload.staged, unstagedFiles: action.payload.unstaged };
