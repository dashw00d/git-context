...
export const SuperWebview: React.FC<{ vscode: any; cockpitState: CockpitState }> = ({ vscode, cockpitState }) => {
    ...
    const [activeTab, setActiveTab] = React.useState<'explorer' | 'stage' | 'inspector' | 'assistant'>('stage');
            ...
            <div style={MainAreaStyle}>
                ...
                {isWide && (
                    <>
                        ...
                        {cockpitState.bundleSummary && (cockpitState.bundleSummary as any).cacheHits !== undefined && (
                            <div style={{
                                position: 'absolute',
                                bottom: '5px',
                                right: '20px',
                                ...
                                Cache: {(cockpitState.bundleSummary as any).cacheHits} hits / {(cockpitState.bundleSummary as any).cacheMisses} misses
                        ...
                        <div style={{
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    textAlign: 'center',
                                    cursor: 'pointer',
                                    borderTop: activeTab !== 'inspector' ? '2px solid var(--vscode-activityBar-foreground)' : '2px solid transparent',
                                    color: activeTab !== 'inspector' ? 'var(--vscode-activityBar-foreground)' : 'var(--vscode-activityBar-inactiveForeground)',
                                    fontSize: '0.85em'
                                }}
                            >
                                Explorer + Stage
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    textAlign: 'center',
                                    cursor: 'pointer',
                                    borderTop: activeTab === 'assistant' ? '2px solid var(--vscode-activityBar-foreground)' : '2px solid transparent',
                                    color: activeTab === 'assistant' ? 'var(--vscode-activityBar-foreground)' : 'var(--vscode-activityBar-inactiveForeground)',
                                    fontSize: '0.85em'
                                }}
                            >
                                Assistant
                            ...
                            {['explorer', 'stage', 'inspector', 'assistant'].map(tab => (
                                <div
                                    ...
                                    style={{
                                        ...
                                        textAlign: 'center',
                                        cursor: 'pointer',
                                        borderTop: activeTab === tab ? '2px solid var(--vscode-activityBar-foreground)' : '2px solid transparent',
                                        color: activeTab === tab ? 'var(--vscode-activityBar-foreground)' : 'var(--vscode-activityBar-inactiveForeground)',
                                        textTransform: 'capitalize',
                                        fontSize: '0.8em'
                                    }}
                                >
                                    {tab === 'explorer' ? '📁' : tab === 'stage' ? '🎯' : tab === 'inspector' ? '🔍' : '🤖'}
                                </div>
                            ))}
                        </div>
                    </div>
