...
This document focuses on architectural patterns. For detailed documentation of individual modules, see the comprehensive module documentation:

### Core Infrastructure

- **[extension.md](../src/extension.md)** - Extension entry point and activation
- **[core.md](../src/core.md)** - Application shell and feature registration
- **[state.md](../src/state.md)** - Redux-style state management system
- **[storage.md](../src/storage.md)** - Database schema and storage operations

### Analysis Engine

- **[analysis.md](../src/analysis.md)** - Core analysis pipeline and steps
- **[facts.md](../src/facts.md)** - Fact detection system (drift, legacy, intended state)

### User Interface

- **[webview.md](../src/webview.md)** - React UI components and cockpit services
- **[providers.md](../src/providers.md)** - VS Code tree view providers

### Business Logic

- **[services.md](../src/services.md)** - Business logic services and data access

### Supporting Modules

- **[cli.md](../src/cli.md)** - Command-line interface (`ct` command)
- **[commands.md](../src/commands.md)** - VS Code command handlers
- **[features.md](../src/features.md)** - Feature registration system
- **[llm.md](../src/llm.md)** - LLM integration and prompt management
- **[utils.md](../src/utils.md)** - Shared utility functions
- **[types.md](../src/types.md)** - TypeScript type definitions
- **[contracts.md](../src/contracts.md)** - Interface contracts and data formats
- **[watchers.md](../src/watchers.md)** - Git event watchers
- **[liveTracker.md](../src/liveTracker.md)** - Real-time workspace change tracking

### Documentation Index

- **[Source Directory Overview](../src/README.md)** - Complete overview of all modules with architecture diagrams
