...
class MermaidGenerator {
     ...
     */
    generateGraph(edges, symbols, options = {}) {
     ...
     */
    generateBlastRadiusGraph(changedSymbols, blastRadius) {
        let mermaid = 'graph TD\n';
     ...
     */
    filterRelevantEdges(edges, maxNodes) {
     ...
     */
    getEdgeStyle(edge, showConfidence) {
        let style = '';
     ...
     * Get edge label
     */
    getEdgeLabel(edge, showConfidence) {
        let label = edge.type;
