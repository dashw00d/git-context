...
class SemanticChangeDetector {
    ...
    calculateMoveConfidence(oldSymbol, newSymbol) {
        ...
        const oldLang = (0, tree_sitter_1.detectLanguage)(oldSymbol.id.split(':')[0]);
        const newLang = (0, tree_sitter_1.detectLanguage)(newSymbol.id.split(':')[0]);
        if (oldLang === newLang) {
            confidence += 0.1;
        }
        return Math.min(confidence, 1.0);
...
//# sourceMappingURL=semanticChanges.js.map